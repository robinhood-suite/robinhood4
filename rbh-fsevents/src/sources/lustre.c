 ...
 */
static void
fsevent_list_alloc(struct rbh_fsevent **_new_events, size_t n_events,
                  struct rbh_id *id)
{
                          ...
                          struct rbh_iterator **fsevents_iterator)
{
    ...
    fsevent_list_alloc(&new_events, 4, id);
                     ...
                     struct rbh_iterator **fsevents_iterator)
{
    ...
    fsevent_list_alloc(&new_events, 2, id);
                         ...
                         struct rbh_iterator **fsevents_iterator)
{
    ...
    fsevent_list_alloc(&new_events, 1, id);
                      ...
                      struct rbh_iterator **fsevents_iterator)
{
    ...
    fsevent_list_alloc(&new_events, 5, id);
                    ...
                    struct rbh_iterator **fsevents_iterator)
{
    ...
    fsevent_list_alloc(&new_events, n_events, renamed_id);
                     ...
                     struct rbh_iterator **fsevents_iterator)
{
    ...
    fsevent_list_alloc(&new_events, 6, id);
...
retry:
    ...
    default: /* CL_MARK or other events */
        /* Events may never be seen as they are often deactivated, so we do not
         * bother and go to the next record.
         */
