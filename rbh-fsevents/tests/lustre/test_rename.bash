...
test_rename_dir()
{
    ...
    local entry_renamed_bis="test_dir_renamed_bis"
    ...
    find_attribute '"ns.name": "'"$entry_renamed"'"' \
        '"ns.xattrs.path": {$exists: false}'

    mv $entry_renamed $entry_renamed_bis

    test_rename $entry_renamed $entry_renamed_bis $count
    find_attribute '"ns.name": "'"$entry_renamed_bis"'"' \
        '"ns.xattrs.path": {$exists: false}'
}
