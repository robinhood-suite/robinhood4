...
START_TEST(rfn_empty)
{
    ...
    fsentry = rbh_fsentry_new(NULL, NULL, NULL, NULL);
...
START_TEST(rfn_id)
{
    ...
    fsentry = rbh_fsentry_new(&ID, NULL, NULL, NULL);
    ck_assert_ptr_nonnull(fsentry);
...
START_TEST(rfn_parent_id)
{
    ...
    fsentry = rbh_fsentry_new(NULL, &PARENT_ID, NULL, NULL);
    ck_assert_ptr_nonnull(fsentry);
...
START_TEST(rfn_name)
{
    ...
    fsentry = rbh_fsentry_new(NULL, NULL, NAME, NULL);
    ck_assert_ptr_nonnull(fsentry);
...
START_TEST(rfn_statx)
{
    ...
    fsentry = rbh_fsentry_new(NULL, NULL, NULL, &STATX);
    ck_assert_ptr_nonnull(fsentry);
