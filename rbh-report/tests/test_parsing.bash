...
test_parsing_output()
{
    ...
    rbh_report rbh:mongo:blob --output "sum" &&
    ...
    rbh_report rbh:mongo:blob --output "sum(statx.size,statx.type)" &&
        error "rbh-report with invalid output string should have failed"
    ...
    rbh_report rbh:mongo:blob --output "sum(statx.size),blob(statx.type)" &&
...
test_parsing_group()
{
    rbh_report rbh:mongo:blob --output "sum(statx.size)" --group &&
    ...
    rbh_report rbh:mongo:blob --output "sum(statx.size)" --group "blob" &&
