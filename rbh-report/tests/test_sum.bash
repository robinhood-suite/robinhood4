...
test_sum_size()
{
    ...
    rbh_report --csv "rbh:mongo:$testdb" --output "sum(statx.size)" |
        difflines "$size"
...
test_sum_mtime()
{
    ...
    rbh_report --csv "rbh:mongo:$testdb" --output "sum(statx.mtime.sec)" |
        difflines "$mtime"
...
test_sum_ino()
{
    ...
    rbh_report --csv "rbh:mongo:$testdb" --output "sum(statx.ino)" |
        difflines "$ino"
}
