...
test_max_size()
{
    ...
    rbh_report "rbh:mongo:$testdb" --output "max(statx.size)" |
        difflines "1025"
...
test_max_mtime()
{
    ...
    rbh_report "rbh:mongo:$testdb" --output "max(statx.mtime.sec)" |
...
test_max_ino()
{
    ...
    rbh_report "rbh:mongo:$testdb" --output "max(statx.ino)" |
        difflines "$third_ino"
}
