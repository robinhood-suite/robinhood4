...
test_syntax_error()
{
    ...
    rbh_find "rbh:mongo:$testdb" -fid fail &&
        error "command should have failed because of invalid syntax"
    rbh_find "rbh:mongo:$testdb" -fid 0x3 &&
        error "command should have failed because of invalid syntax"
    rbh_find "rbh:mongo:$testdb" -fid 0x3:0x4 &&
        error "command should have failed because of invalid syntax"
    rbh_find "rbh:mongo:$testdb" -fid "0x3:0x4:0x5]" &&
        error "command should have failed because of invalid syntax"
    rbh_find "rbh:mongo:$testdb" -fid "0x3:0x4:0x5]]" &&
        error "command should have failed because of invalid syntax"
    rbh_find "rbh:mongo:$testdb" -fid "[0x3:0x4:0x5" &&
    ...
    rbh_find "rbh:mongo:$testdb" -fid "[0x3:0x4:0x5]]" &&
        error "command should have failed because of invalid syntax"
    rbh_find "rbh:mongo:$testdb" -fid "[0x3:0x4:0x5]invalid" &&
        error "command should have failed because of invalid syntax"
    rbh_find "rbh:mongo:$testdb" -fid "[0x3:0x4:0x5)" &&
        error "command should have failed because of invalid syntax"
    rbh_find "rbh:mongo:$testdb" -fid "]0x3:0x4:0x5[" &&
...
test_unknown_fid()
{
    ...
    rbh_find "rbh:mongo:$testdb" -fid 0x0:0x0:0x0 | sort |
        difflines
}
...
test_known_fid()
{
    ...
    rbh_find "rbh:mongo:$testdb" -fid "$fid" | sort |
        difflines "/$file"
