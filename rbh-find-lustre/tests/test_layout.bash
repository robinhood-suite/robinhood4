...
test_invalid()
{
    rbh_lfind "rbh:mongo:$testdb" -layout 42 &&
        error "find with an invalid layout should have failed"

    rbh_lfind "rbh:mongo:$testdb" -layout invalid &&
        error "find with an invalid layout should have failed"
...
test_default()
{
    ...
    rbh_lfind "rbh:mongo:$testdb" -layout default | sort |
        difflines "/" "/$dir"
...
test_layout()
{
    ...
    rbh_lfind "rbh:mongo:$testdb" -layout raid0 | sort |
        difflines "/" "/$dir/$file"
    rbh_lfind "rbh:mongo:$testdb" -layout mdt | sort |
        difflines "/$dir"
...
test_other_layouts()
{
    ...
    rbh_lfind "rbh:mongo:$testdb" -layout overstriped | sort |
        difflines "/$file1"
    rbh_lfind "rbh:mongo:$testdb" -layout released | sort |
        difflines "/$file2"
}
