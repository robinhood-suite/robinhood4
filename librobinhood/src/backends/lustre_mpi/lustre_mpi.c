                        ...
                        int statx_sync_type)
{
    ...
    mpi_iter->backend_id = RBH_BI_LUSTRE;
...
static const struct rbh_value LUSTRE_STRING_TYPE = {
    .type = RBH_VT_STRING,
    .string = "lustre",
};

static const struct rbh_value MPI_STRING_TYPE = {
    .type = RBH_VT_STRING,
    .string = "mpi"
};
...
static const struct rbh_value RBH_LUSTRE_MPI_BACKEND_TYPE = {
...
rbh_lustre_mpi_backend_new(const char *path, struct rbh_config *config)
{
    ...
    lustre_mpi->backend.backend_type = &RBH_LUSTRE_MPI_BACKEND_TYPE;
