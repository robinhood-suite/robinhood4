...
static const struct rbh_value HESTIA_STRING_INFO = {
    .type = RBH_VT_STRING,
    .string = "hestia"
};

static const struct rbh_value RBH_HESTIA_BACKEND_INFO = {
    .type = RBH_VT_SEQUENCE,
    .sequence = {
        .values = &HESTIA_STRING_INFO,
        .count = 1,
    },
};
...
static const struct rbh_backend HESTIA_BACKEND = {
    ...
    .backend_info = &RBH_HESTIA_BACKEND_INFO,
