               ...
               char **predicate_helper, char **directive_helper)
{
    ...
    rc = asprintf(predicate_helper,
        ...
        "                         filter directories with a default ACL\n"
        "                         entry for a named group\n"
        "    -acl-readable SUBJECT\n"
        "                         filter entries readable by SUBJECT\n"
        "    -acl-writable SUBJECT\n"
        "                         filter entries writable by SUBJECT\n"
        "    -acl-executable SUBJECT\n"
        "                         filter entries executable by SUBJECT\n"
        "\n"
