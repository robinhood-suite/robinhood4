...
mfu_iter_next(void *_iter)
{
    ...
    while (true) {
        ...
        /* FIXME: Depending on the order in which entries are processed
         * (depth-first or breadth-first), a directory might not have the
         * correct nb_children value.
         *
         * If we see '/dir', '/dir/fileB', and '/fileA'; '/' will not have the
         * correct value, as MFU will think it is a completely new directory
         * when encountering '/fileA'.
         */
