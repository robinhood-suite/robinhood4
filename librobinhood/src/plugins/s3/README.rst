...
Here are the additional information provided by the S3 plugin:
...
Only the predicates different from the POSIX plugin will be explain.
...
They corresponds to which data is printed when using the `-printf` and `-fprint`
actions of rbh-find_.
...
+=============+============================================+
|     '%b'    | The bucket the entry belong to             |
+-------------+--------------------------------------------+
