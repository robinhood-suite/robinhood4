...
usage(void)
{
    const char *message =
        ...
        "    -group GROUP         filter entries based on their owner group name\n"
        "    -nouser              select entries wthout valid owner IDs\n"
        ...
        "    -uid UID             filter entries based on their owner ID\n"
        "    -user USER           filter entries based on their owner name\n"
        "\n"
        "Action arguments:\n"
