...
usage(void)
{
    const char *message =
        ...
        "    -[ac]newer PATH      filter entries with an access or change time\n"
        "                         greater than the modify time of PATH. This\n"
        "                         filter can be slower as we need to retrieve\n"
        "                         the modify time of PATH first\n"
        ...
        "    -iregex PATTERN      filter entries like -regex, but the filter is\n"
        "                         case insensitive\n"
        "    -ilname PATTERN      filter entries like -lname, but the filter is\n"
        "                         case insensitive\n"
        "    -links [+-] N        filter entries based on their number of links\n"
        "    -lname PATTERN       filter entries that are a symbolic links and\n"
        "                         whose content matches the shell pattern\n"
        "    -newer PATH          filter entries with a modify time greater than\n"
        "                         the modify time of PATH. This filter can be\n"
        "                         slower as we need to retrieve the modify time\n"
        "                         of PATH first\n"
        ...
        "    -regex PATTERN       filter entries based on a regular expression\n"
        "                         pattern. This is a filter on the whole path\n"
