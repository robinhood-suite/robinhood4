...
librbh.rbh_pe_free_backend.restype = None
librbh.rbh_pe_free_backend.argtypes = [c_void_p]
...
def make_c_policy(py_policy):
    ...
    if getattr(py_policy, "stoptrigger", None) is not None:
        def stop_trigger_cb():
            try:
                decision = evaluate_trigger(
                    py_policy.stoptrigger,
...
def resolve_backend_info(uri: str, getter) -> str:
    ...
    try:
        ...
        librbh.rbh_pe_free_backend(backend_ptr)
