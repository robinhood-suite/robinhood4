...
def backend_sort_to_dsl_name(backend_sort_name):
    for dsl_name, backend_name in policy_sort_keywords.items():
        if backend_name == backend_sort_name:
            return dsl_name

    return backend_sort_name
