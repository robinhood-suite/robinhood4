...
if __name__ == "__main__":
    ...
    run_parser.add_argument("--source", metavar="URI",
            help="Override the source filesystem URI for one execution")
    run_parser.add_argument("--mirror", metavar="URI",
            help="Override the mirror database URI for one execution")
    ...
    if args.command == "run":
        ...
        set_config_override(backend=args.source, database=args.mirror)
